...
namespace JimmyLinqUnitTests
{
    ...
    public class ComicAnalyserTests
    {
        ...
        [TestMethod]
        public void ComicAnalyser_Should_Generate_A_List_Of_Reviews()
        {
            var testReviews = new[]
            {
            ...
            var actualResults = ComicAnalyser.GetReviews(testComics, testReviews).ToList();
            CollectionAssert.AreEqual(expectedResults, actualResults);
        }

        [TestMethod]
        public void ComicAnalyser_Should_Handle_Weird_Review_Scores()
        {
            var testReviews = new[]
            {
